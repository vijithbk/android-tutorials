...
public class ApplicationLevelActivity extends AppCompatActivity {
    EditText etName;
    ...
    public void gotoHome(View view) {
        Intent myIntent = new Intent(ApplicationLevelActivity.this, LandingActivity.class);
        ApplicationLevelActivity.this.startActivity(myIntent);
    }
